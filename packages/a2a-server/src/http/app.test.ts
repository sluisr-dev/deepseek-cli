...
import { MockTool } from '@sluisr/deepseek-cli-core/src/test-utils/mock-tool.js';
...
vi.mock('@sluisr/deepseek-cli-core', async () => {
  const actual = await vi.importActual('@sluisr/deepseek-cli-core');
  return {
    ...actual,
